...
def process_augmentation(source_dir: Path, output_dir: Path, multiplier: int = 3):
    ...
    for subset in ["train", "valid"]:
        ...
        for img_path in img_in.glob("*.*"):
            ...
            # CASE 2: Valid - just copy files directly
            else:
...
def main(multiplier: int = 4):
    ...
    ds_out = settings.DATASET_AUGMENTOR_RESULTS

    process_augmentation(ds_in, ds_out, multiplier)
